...
class My extends TagLib {
    ...
    public function _layer(){
        $str=<<<php
<script src="__STATICS__/layer/layer.js"></script>
<script src="__STATICS__/layer/extend/layer.ext.js"></script>        
php;
        return $str;
    }
    ...
    public function _jquery(){
        $str=<<<php
<script src="__STATICS__/js/jquery-1.10.2.min.js"></script>    
php;
        return $str;
    }
    ...
    public function _vue(){
        $str=<<<php
<script src="__STATICS__/vue/vue.js"></script>    
<script src="__STATICS__/vue/vue-resource.min.js"></script> 
<script>
...
php;
    ...
    */
    public function _datejs($tag){
        ...
        $link=<<<php
<script src="__STATICS__/laydate-v1.1/laydate.js"></script>
<script>
...
php;
    ...
    public function _animate(){
        return '<link rel="stylesheet" href="__STATICS__/css/animate.css">';
    }
    ...
    */
    public function _icheckcss(){
        $link=<<<php
    <link rel="stylesheet" href="__STATICS__/iCheck-1.0.2/skins/all.css">
php;
        return $link;
    }
    ...
    */
    public function _icheckjs($tag){
        ...
        $link=<<<php
<script src="__STATICS__/iCheck-1.0.2/icheck.min.js"></script>
<script>
...
php;
    ...
    <link rel="stylesheet" href="__STATICS__/bootstrap-3.3.5/css/bootstrap.min.css" />
    <link rel="stylesheet" href="__STATICS__/bootstrap-3.3.5/css/bootstrap-theme.min.css" />
    <link rel="stylesheet" href="__STATICS__/font-awesome-4.4.0/css/font-awesome.min.css" />
...
<!-- 引入bootstrjs部分开始 -->
<script src="__STATICS__/js/jquery-1.10.2.min.js"></script>
<script src="__STATICS__/bootstrap-3.3.5/js/bootstrap.min.js"></script>
...
php;
    ...
    public function _suicss($tag,$content) {
        $link=<<<php
<link rel="stylesheet" href="__STATICS__/sui-0.6.1/css/sm.min.css">
php;
    return $link;
    }
    ...
    public function _suijs($tag,$content) {
        $link=<<<php
<script src="__STATICS__/js/zepto-1.1.6.min.js"></script>
<script src="__STATICS__/sui-0.6.1/js/sm.min.js"></script>
<script>
    $.init();
</script>
php;
    ...
    <link rel="stylesheet" href="__STATICS__/Framework7-1.2.0/css/framework7.ios.min.css" />
    <link rel="stylesheet" href="__STATICS__/Framework7-1.2.0/css/framework7.ios.colors.min.css" />
php;
    return $link;
    }
    ...
    public function _framework7js($tag,$content) {
        $link=<<<php
    <script src="__STATICS__/Framework7-1.2.0/js/framework7.min.js"></script>
php;
    return $link;
    }
    ...
    <link rel="stylesheet" href="__STATICS__/frozenui-1.3.0/css/frozen.css" />
    <link rel="stylesheet" href="__PUBLIC_CSS__/base.css" />
php;
    return $link;
    }
    ...
    public function _frozenuijs($tag,$content) {
        $link=<<<php
<script src="__STATICS__/frozenui-1.3.0/lib/zepto.min.js"></script>
<script src="__STATICS__/frozenui-1.3.0/js/frozen.js"></script>
<script src="__PUBLIC_JS__/base.js"></script>
php;
    return $link;
    }
...
php;
    ...
    public function _webuploadercss(){
        $str=<<<php
<link rel="stylesheet" href="__STATICS__/webuploader-0.1.5/xb-webuploader.css">
<script src="__STATICS__/js/jquery-1.10.2.min.js"></script>
php;
        return $str;
    }
